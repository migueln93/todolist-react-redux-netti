...
import {deleteTodo, toggleTodo, setVisibilityFilter} from '../actions/simpleActions';
        ...
        {this.props.todos.length !== 0 ? (
            ...
            <thead>
                ...
                <tbody>
                    ...
                    >
                        {todo.text} {todo.completed === true ? "(completado)" : ""}
                        </td>
                        <td>
            ...
            Está vacio o no se muestra los resultados 
            </div>
        </div>
        )}{" "}
        </div>
